...
//        map.put("idcard", getTelephone());
    ...
    public static String createName(){
        String[] str1 = {"赵","钱","孙","李","周","吴","郑", "王", "冯", "陈", "诸", "卫", "蒋", "沈",
                "韩", "杨", "朱", "秦", "尤", "许", "何", "吕", "施", "张", "孔", "曹", "严", "华", "金", "魏",
                "陶", "姜","戚", "谢", "邹", "喻", "柏", "水", "窦", "章", "云", "苏", "潘", "葛", "奚",
                "范", "彭", "郎", "鲁", "韦", "昌", "马", "苗", "凤", "花", "方", "俞", "任", "袁", "柳", "鲍",
                "史", "唐", "费", "廉", "岑", "薛", "雷", "贺", "倪", "汤"};
        String[] str2 = {"婧", "林", "豪", "川", "光", "宇", "玉", "凤", "凡", "春", "钱", "倩", "华", "茜", "云",
                "泉", "芳", "梓", "柯", "全", "峰", "勇", "丽", "静", "亮", "萍", "琴", "小", "鲁", "蓉", "莉",
                "俊", "卓", "杰", "磊", "雷", "耀", "忠", "孟", "安", "国", "昆", "坤", "辉", "智"};
        String[] str3 = {"文", "温","", "龙","", "鹏", "研", "泉","","", "兰", "兵","", "敏", "爱", "燕",
                "遥","","", "焦","", "严", "南", "红","", "凡", "英","", "影","","", "如", "群", "娜","", "智", "温",
                "龙", "鹏","", "研", "泉", "兰", "兵", "敏","", "爱", "燕", "遥", "焦","","", "严", "南","", "红",
                "凡","", "英", "影","如", "群", "娜", "智"};
        String name = str1[new Random().nextInt(str1.length)]+str2[new Random().nextInt(str2.length)]+str3[new Random().nextInt(str3.length)];
